  ...
  const reasons: IReason[] = [
    {
      ...
      icon: "💳",
      benefits: ["Planes de pago flexibles", "Tasas preferenciales", "Sin intereses en 6 meses", "Aprobación rápida"],
      category: "financiamiento",
    },
    {
      id: "consultas-gratuitas",
      title: "Consultas Gratis a Domicilio",
      description:
        "Visitamos tu hogar o empresa sin costo para evaluar tus necesidades eléctricas y brindarte un presupuesto detallado y personalizado.",
      icon: "🏠",
      benefits: [
    ...
    {
      id: "servicio-galardonado",
      title: "Servicio Galardonado",
      description:
        "Reconocidos por la excelencia en nuestros trabajos con más de 500 proyectos exitosos y certificaciones de calidad internacionales.",
      icon: "🏆",
      benefits: ["500+ proyectos exitosos", "Certificaciones ISO", "Reconocimientos del sector", "Garantía extendida"],
      category: "calidad",
    },
    {
      id: "autorizados-asegurados",
      title: "Autorizados y Asegurados",
      description:
        "Contamos con todas las habilitaciones legales, seguros de responsabilidad civil y certificaciones técnicas para garantizar tu tranquilidad.",
      icon: "🛡️",
      benefits: [
    ...
    <>
      ...
      >
        ...
        <header className="text-center mb-16">
          <h2 id="why-choose-us-heading" className="text-4xl sm:text-5xl lg:text-6xl mb-6 font-semibold text-gray-900">
            ¿Por qué <span className="text-primary">elegirnos</span>?
          </h2>
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Más de 10 años de experiencia nos respaldan. Descubre las razones por las que somos la mejor opción para tus
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm sm:text-base text-gray-600">Soporte Técnico</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl sm:text-4xl font-bold text-primary">100%</div>
              <div className="text-sm sm:text-base text-gray-600">Satisfacción Garantizada</div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-16">
          <p className="text-lg text-gray-600 mb-6">¿Listo para comenzar tu proyecto?</p>
          <a
            href="#contacto"
            className="
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "Empresa líder en instalaciones eléctricas con más de 10 años de experiencia",
            foundingDate: "2014",
